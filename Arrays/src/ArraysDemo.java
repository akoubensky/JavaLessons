...
//    Задача: Перевернуть массив, функция(массив) статик воид, получает массив из целых
//    Задача: Написать функцию которая работает так же как arrays equals (свою) которая получает
//    2а массива из целых в качестве параметра и сравнивает их на равенство.
//    Задача: Функция getMax выбирает максимальные элементы из массива (2а аргумента массив из целых
